    ...
    spec = {
      ...
      template = {
        ...
        spec = {
          containers = [{
            name = "exporter";
            image = "docker.io/python:3.13.1-slim";
            ...
            env = [
              { name = "STORAGE_PATH"; value = "/data/storage"; }
              { name = "PORT"; value = "9101"; }
              { name = "SCAN_INTERVAL"; value = "300"; }
            ...
            volumeMounts = [
              { name = "storage"; mountPath = "/data/storage"; readOnly = true; }
            ...
            readinessProbe = {
              httpGet = { path = "/metrics"; port = 9101; };
